module.exports = (dateArrival, dateDeparture) => {
    ...
    const hourDeparture = departure.getHours().toString().padStart(2, '0') + ":" + departure.getMinutes().toString().padStart(2, '0');
    const hourArrival = arrival.getHours().toString().padStart(2, '0') + ":" + arrival.getMinutes().toString().padStart(2, '0');
